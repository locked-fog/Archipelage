...
install -Dm644 archipelago-plugin-notification-center-0.1.0-1-x86_64.pkg.tar.zst /srv/pacman/localrepo/x86_64/
repo-add /srv/pacman/localrepo/x86_64/localrepo.db.tar.gz /srv/pacman/localrepo/x86_64/archipelago-plugin-notification-center-0.1.0-1-x86_64.pkg.tar.zst
```
